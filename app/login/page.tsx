  ...
  return (
    <MobileLayout>
      <div className="flex flex-col h-full">
        <h1 className="text-[36px] font-medium tracking-[0.36px] text-[#2b2b2b] mb-8">Login</h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1">
          ...
          <div className="mb-4">
            <button
              type="submit"
              className={`w-[332px] h-[59px] mx-auto flex items-center justify-center bg-[#2b2b2b] rounded-[15px] ${
